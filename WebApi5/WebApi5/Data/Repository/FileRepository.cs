...
namespace WebApi5.Data.Repository
{
    public class FileRepository : IVersionFiles{
        ...
        public File GetFile(int fileId) => appDBContent.File.FirstOrDefault(p => p.id == fileId);#1#
        

        /*IEnumerable<File> IVersionFiles.GetAllVersionFiles => throw new System.NotImplementedException();

        public File GetFirstVersionFile => appDBContent.File.FirstOrDefault(c => c.fileId == 1);#1#

        /*public File GetLatestVersionFile => throw new System.NotImplementedException();#1#
